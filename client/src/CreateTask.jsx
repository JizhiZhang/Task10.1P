...
import { Container, Segment, Button, Modal } from 'semantic-ui-react';
  ...
  return (
    <div>
      <Container>
        <Segment>
          ...
          <div className='action-buttons'>
            ...
            <Button positive onClick={saveTask} style={{background:"orange", border:"orange", color:"black"}}>Save</Button>
          </div>
        </Segment>
      </Container>
      ...
      >
        ...
        <Modal.Actions>
          <Button positive onClick={closeModal} style={{background:"orange", border:"orange", color:"black"}}>
            OK
          </Button>
        </Modal.Actions>
      </Modal>
